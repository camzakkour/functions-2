...
// CODE HERE
const totalPopulation = populations.reduce ((num1, num2) => {
  return num1 + num2
})
...
// CODE HERE
const totalPrice = orders.map((num) => num.price * (num.tax + 1))
...
// CODE HERE
const bobsTotal = purchases.filter(purchases => purchases.owner === 'Bob').reduce((acc, purchase) => acc + purchase.price, 0)
